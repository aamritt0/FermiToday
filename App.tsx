...
const EventCard = React.memo(
  ({
    ...
    const descriptionStyle = isDark
      ...
      : styles.description;
    const timeContainerStyle = isDark
      ? styles.timeContainerDark
      ...
      >
        ...
        <View style={styles.eventContent}>
          ...
          <View style={timeContainerStyle}>
            ...
            />
            <Text style={timeTextStyle}>{formatTime()}</Text>
          </View>
        </View>
      </Animated.View>
    );
...
export default function App() {
  ...
  const [viewMode, setViewMode] = useState<"section" | "professor" | "all">(
    "section"
  );
  ...
  const saveSettings = async () => {
    try {
      ...
      await AsyncStorage.setItem(
        "savedProfessors",
        JSON.stringify(savedProfessors)
      );
    } catch (error) {
  ...
  const fetchEvents = React.useCallback(
    async (
      ...
      try {
        ...
        // Filter events by date (handle both all-day and timed events)
        ...
        if (viewMode === "section") {
          ...
          filteredEvents = filterEventsByProfessor(
            filteredEvents,
            professorToFetch
          );
        }
        ...
        filteredEvents.sort((a: Event, b: Event) => {
          ...
          const bTime =
            typeof b.start === "string" && b.start.length === 10
              ? 0
        ...
        if (err.code === "ECONNABORTED") {
          ...
          errorMessage =
            "Nessuna connessione al server. Controlla la tua connessione internet.";
        }
  ...
  const searchContainerStyle = isDark
    ...
    <SafeAreaView style={containerStyle} edges={["top", "left", "right"]}>
      ...
      <View
        style={[
          ...
          isDark && styles.viewModeContainerDark,
        ]}
      >
        <TouchableOpacity
          style={[
        ...
        >
          <MaterialIcons
            ...
            size={18}
            color={
              viewMode === "section" ? "#6366f1" : isDark ? "#999" : "#666"
            }
          />
          <Text
            style={[
        ...
        >
          <MaterialIcons
            ...
            size={18}
            color={
              viewMode === "professor" ? "#6366f1" : isDark ? "#999" : "#666"
            }
          />
          <Text
            style={[
      ...
      {viewMode === "section" && savedSections.length > 0 && (
        <View
          style={
            isDark ? styles.quickSelectWrapperDark : styles.quickSelectWrapper
          }
        >
          <ScrollView
            horizontal
      ...
      <View
        style={[
          ...
          isDark && styles.dateFilterContainerDark,
        ]}
      >
        <TouchableOpacity
          style={[
        ...
        >
          <MaterialIcons
            ...
            size={18}
            color={
              dateFilter === "today" ? "#6366f1" : isDark ? "#999" : "#666"
            }
          />
          <Text
            style={[
        ...
        >
          <MaterialIcons
            ...
            size={18}
            color={
              dateFilter === "tomorrow" ? "#6366f1" : isDark ? "#999" : "#666"
            }
          />
          <Text
            style={[
        ...
        {loading ? (
          <View style={styles.centerContainer}>
            <View style={styles.loader}>
              ...
              />
              <Text
                style={[styles.loaderText, isDark && styles.loaderTextDark]}
              >
                Loading...
              </Text>
            </View>
            ...
            >
                ...
                <View style={styles.sectionHeaderText}>
                  ...
                  <Text
                    style={[
                      ...
                      isDark && styles.sectionSubtextDark,
                    ]}
                  >
              ...
              {savedSections.map((sec) => (
                <View
                  key={sec}
                  style={[
                    styles.savedSectionRow,
                    isDark && styles.savedSectionRowDark,
                  ]}
                >
                  <View style={styles.savedSectionLeft}>
                    ...
                    <Text
                      style={[
                        styles.savedSectionText,
                        isDark && styles.savedSectionTextDark,
                      ]}
                    >
                      {sec}
                    </Text>
              ...
              <Text
                style={[styles.aboutSubtext, isDark && styles.aboutSubtextDark]}
              >
                Visualizza le variazioni dell'orario giornaliero della tua
                classe, dei tuoi professori, o quella dei tuoi amici.{"\n"}Basta
                inserire la classe o il nome del professore per vedere eventuali
                modifiche all'orario di oggi.{"\n"}NON UFFICIALE
              </Text>
              <Text
      ...
      {notification && (
        ...
        >
          <MaterialIcons
            name={
              notification.type === "error" ? "error-outline" : "info-outline"
            }
            size={24}
            color="#fff"
          />
